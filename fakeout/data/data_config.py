...
FILTERED_TEST_FILE = "filtered_test.txt"
...
DATASET_CONFIG = {
    "dfdc": {
        ...
        DATASET_FOLDER: "fakeout/data/DFDC/tmp",
        DIRECTORY_NAME: 'DFDC',
    ...
    "celeb_df": {
        ...
        DATASET_FOLDER: "fakeout/data/Celeb_DF_v2/tmp",
    ...
    "deeper_forensics": {
        ...
        DATASET_FOLDER: "fakeout/data/DeeperForensics/tmp",
    ...
    "face_shifter": {
        ...
        DATASET_FOLDER: "fakeout/data/FaceShifter/tmp",
    ...
    "face_forensics": {
        ...
        DATASET_FOLDER: "fakeout/data/FaceForensics/tmp",
